...
const banner2 = () => {
    return (
        <div className='w-full h-screen'>
            <img className='top-0 left-0 w-full h-[600px] object-cover' src="http://localhost:3000/images/banner2.webp" alt="" />
            <div className='absolute top-3 left-0 w-full h-screen'>
                <div className='absolute top-3 w-full h-full flex flex-col justify-center text-white'>
                    <div className='md:left-[10%] max-w-[800px] m-auto absolute mt-[200px]'>
                        <h1 className='font-bold text-4xl text-center sm:text-left md:text-6xl z-10'>Konsultasi</h1>
